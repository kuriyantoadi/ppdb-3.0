      ...
      <br>
      <h4>C. DATA ALAMAT TEMPAT TINGGAL SESUAI KK CALON PESERTA DIDIK</h4>
      <div class="form-group">
      ...
      <div class="form-group">
        <label class="control-label col-sm-2" for="email">Jarak Alamat Siswa ke Sekolah :</label><b>KM</b>
        <div class="col-sm-4">
      ...
      <!-- <br>
      <h4>G. KONDISI FISIK DAN KEBIASAAN</h4>
      <div class="form-group">
      ...
      <br> -->
            ...
            <h4>E. INPUT SCAN BERKAS CALON PESERTA DIDIK</h4>
            <div class="form-group">
            ...
            <h5><b>Informasi :</h5>
            <h5>1. File harus dengan format <b>.pdf</b> dengan ukuran maksimal <b>500 kb</b></h5>
            <h5>2. Dokumen yang di <b>Scan Harus Asli (bukan Photo Copy)</b></h5>
            <h5>3. Piagam/Sertifikat dan PKH/KKS/KIP/Jamsosda boleh dikosongkan</h5>
            <h5>4. Piagam/Sertifikat hasil perlombaan dan/atau penghargaan di bidang akademik maupun non akademik</h5>
            <h5>5. Piagam/Sertifikat boleh di isi bukti hafiz alquran atau bukti hafal kitab sesuai agama yang dianut</h5>
            <h5>7. Surat sehat harus ditandatangani oleh dokter pemerintah.</h5>
            <h5>8. Proses daftar tergatung jaringan internet, karena file yang diupload cukup banyak</h5>
